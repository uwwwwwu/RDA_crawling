...
public class RDA_oasis_carry {
	...
	public static void main(String args[]) throws IOException {
		...
		for (int year = 2010; year <= 2017; year++) {
			BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File(year + "cham_carry.csv")));
			...
			for (int month = 1; month <= 12; month++) {
				...
				for (int day = 0; day < calendar.getActualMaximum(Calendar.DAY_OF_MONTH); day++) {
					...
					Document document = Jsoup.connect("http://oasis.krei.re.kr/basicInfo/wholesale/qty.do?cmd=service&gubun=0&noData=32210&excelMode=&codeType=code4&pageIndex=1&checkType=true&dynamicCode=TB12&codeStr1=CS008&mode=FIX&fileName=&sCalendar="+date+"&eCalendar="+date+"&code1=08&code2=0802&code3=080206&code4=210009&code4=350402&code4=310401&code4=210001&code4=380201&code4=220001&code4=360301&code4=370101&code4=370401&code4=110001&code4=380401&code4=240001&code4=350101&code4=360201&code4=110008&code4=250001&code4=230003&code4=310101&code4=330201&code4=310901&code4=330101&code4=360101&code4=380303&code4=240004&code4=311201&code4=320101&code4=371501&code4=250003&code4=320301&code4=340101&code4=230001&code4=380101&code4=320201&code4=350301&searchStartDate=2016-04-19&pageUnit=20").post();

					try {
						System.out.println("\"" + document.select("td:contains(총 합계)").get(0).nextElementSibling()
								.nextElementSibling().text() + "\"");
						bufferedWriter.append("\"" + document.select("td:contains(총 합계)").get(0).nextElementSibling()
								.nextElementSibling().text() + "\"");
						bufferedWriter.append(COMMA_DELIMITER);
